...
"""Entry point for the InOrbit {{ cookiecutter.connector_target }} Connector."""
...
# Local
from {{cookiecutter.connector_slug}}_connector import __version__
from {{cookiecutter.connector_slug}}_connector.src.config.models import {{cookiecutter.connector_slug_pascal}}ConnectorConfig
from {{cookiecutter.connector_slug}}_connector.src.connector import {{cookiecutter.connector_slug_pascal}}Connector
...
def start() -> None:
    ...
    parser = CustomParser(
        ...
        description="InOrbit {{ cookiecutter.connector_target }} Connector",
    )
    parser.add_argument(
        "-c",
        "--config",
    ...
    try:
        ...
        config = {{cookiecutter.connector_slug_pascal}}ConnectorConfig(**yaml_data)
    ...
    connector = {{cookiecutter.connector_slug_pascal}}Connector(config)
    LOGGER.info("Starting {{ cookiecutter.connector_target }} Connector...")
    connector.start()
