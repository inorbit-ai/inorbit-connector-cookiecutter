...
# This script builds the Docker image for the {{ cookiecutter.connector_target }} Connector.
...
IMAGE_NAME="us-central1-docker.pkg.dev/inorbit-integrations/connectors/{{cookiecutter.connector_slug}}_connector"
IMAGE_NAME_SHORT="{{cookiecutter.connector_slug}}_connector"
